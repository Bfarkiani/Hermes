...
sleep 20
d=$(date +%H-%M-%S)
RESULTS_FILE_ONL=${PWD}/RESULTS/${INPUT_FILE}_ONL_50b_${d}_direct
RESULTS_FILE_ARL=${PWD}/RESULTS/${INPUT_FILE}_ARL_50mb_${d}_direct
...
echo "running again"
d=$(date +%H-%M-%S)
RESULTS_FILE_ONL=${PWD}/RESULTS/${INPUT_FILE}_ONL_50mb_${d}_direct
RESULTS_FILE_ARL=${PWD}/RESULTS/${INPUT_FILE}_ARL_50mb_${d}_direct
