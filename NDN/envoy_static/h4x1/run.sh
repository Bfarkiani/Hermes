...
nohup docker run --rm -p 0.0.0.0:9001:9001 -p 0.0.0.0:12000:12000/udp -p 0.0.0.0:12000:12000/tcp -p 0.0.0.0:7000:7000/udp -p 0.0.0.0:7000:7000/tcp --network host -v "$PWD":/etc/envoy --name h4x2 -t envoyproxy/envoy-dev:448cbd60ee4e1af1f869f9f519095680b233f1e2 > h4x1_Log.txt 2>&1 &
